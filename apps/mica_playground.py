...
:root[data-theme=macchiato]{--rosewater:#f4dbd6;--flamingo:#f0c6c6;--pink:#f5bde6;--mauve:#c6a0f6;--red:#ed8796;--peach:#f5a97f;--yellow:#eed49f;--green:#a6da95;--teal:#8bd5ca;--sky:#91d7e3;--sapphire:#7dc4e4;--blue:#8aadf4;--lavender:#b7bdf8;--text:#cad3f5;--subtext:#a5adcb;--overlay:#6e738d;--surface1:#494d64;--surface0:#363a4f;--base:#24273a;--mantle:#1e2030;--crust:#181926;--line:#363a4f;--panel:#1e2030;--muted:#a5adcb}
:root[data-theme=frappe]{--rosewater:#f2d5cf;--flamingo:#eebebe;--pink:#f4b8e4;--mauve:#ca9ee6;--red:#e78284;--peach:#ef9f76;--yellow:#e5c890;--green:#a6d189;--teal:#81c8be;--sky:#99d1db;--sapphire:#85c1dc;--blue:#8caaee;--lavender:#babbf1;--text:#c6d0f5;--subtext:#a5adce;--overlay:#737994;--surface1:#51576d;--surface0:#414559;--base:#303446;--mantle:#292c3c;--crust:#232634;--line:#414559;--panel:#292c3c;--muted:#a5adce}
:root[data-theme=latte]{color-scheme:light;--rosewater:#dc8a78;--flamingo:#dd7878;--pink:#ea76cb;--mauve:#8839ef;--red:#d20f39;--peach:#fe640b;--yellow:#df8e1d;--green:#40a02b;--teal:#179299;--sky:#04a5e5;--sapphire:#209fb5;--blue:#1e66f5;--lavender:#7287fd;--text:#4c4f69;--subtext:#6c6f85;--overlay:#9ca0b0;--surface1:#bcc0cc;--surface0:#ccd0da;--base:#eff1f5;--mantle:#e6e9ef;--crust:#dce0e8;--line:#ccd0da;--panel:#e6e9ef;--muted:#6c6f85}
*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 16% -12%,var(--surface0) 0,transparent 34%),radial-gradient(circle at 88% -4%,var(--mantle) 0,transparent 28%),var(--crust);color:var(--text);font:15px Inter,ui-sans-serif,system-ui}
.app{position:relative;max-width:1040px;height:calc(100vh - 24px);margin:12px auto;display:grid;grid-template-rows:auto 1fr auto;background:color-mix(in srgb,var(--base) 92%,transparent);border:1px solid var(--surface0);border-radius:26px;box-shadow:0 24px 90px color-mix(in srgb,var(--crust) 72%,transparent);overflow:hidden}
.top{padding:12px 18px;border-bottom:1px solid var(--line);display:flex;gap:12px;align-items:center;background:color-mix(in srgb,var(--mantle) 93%,transparent);backdrop-filter:blur(18px)}
.brand{display:flex;align-items:center;gap:11px}.logo{width:42px;height:42px;padding:5px;border:1px solid color-mix(in srgb,var(--lavender) 28%,transparent);border-radius:14px;background:linear-gradient(145deg,var(--surface0),var(--mantle));box-shadow:inset 0 1px color-mix(in srgb,var(--text) 8%,transparent),0 5px 14px color-mix(in srgb,var(--crust) 55%,transparent);object-fit:contain}.title strong{display:block;font-size:18px;letter-spacing:.01em;color:var(--text)}.title small{display:block;color:var(--subtext);font-size:11px}
...
.chat{overflow:auto;padding:26px;display:flex;flex-direction:column}.message-row{display:flex;align-items:flex-end;gap:10px;max-width:86%;margin:9px 0}.message-row.user{align-self:flex-end;flex-direction:row-reverse}.message-row.assistant{align-self:flex-start}.avatar{width:35px;height:35px;flex:0 0 35px;border-radius:50%;display:grid;place-items:center;border:1px solid var(--surface1);box-shadow:0 5px 14px color-mix(in srgb,var(--crust) 40%,transparent)}.assistant-avatar{background:linear-gradient(145deg,var(--surface1),var(--surface0))}.assistant-avatar img{width:25px;height:25px;object-fit:contain}.user-avatar{background:linear-gradient(145deg,var(--pink),var(--mauve));border-color:color-mix(in srgb,var(--pink) 55%,transparent)}.user-avatar svg{width:19px;height:19px;fill:none;stroke:var(--crust);stroke-width:2.2;stroke-linecap:round;stroke-linejoin:round}.message{min-width:52px;padding:13px 16px;white-space:pre-wrap;line-height:1.48;box-shadow:0 7px 24px color-mix(in srgb,var(--crust) 35%,transparent)}.user .message{background:var(--surface1);color:var(--text);border:1px solid var(--overlay);border-radius:22px 22px 7px 22px}.assistant .message{background:var(--mantle);border:1px solid var(--surface0);border-radius:22px 22px 22px 7px}.meta{display:inline-flex;width:fit-content;max-width:100%;align-items:center;gap:5px;margin-top:10px;padding:5px 9px;border:1px solid color-mix(in srgb,var(--blue) 30%,transparent);border-radius:999px;background:color-mix(in srgb,var(--blue) 8%,transparent);color:var(--blue);font-size:11px;white-space:normal}.agent-activity{align-self:flex-start;display:flex;align-items:center;gap:8px;margin:4px 0 4px 45px;padding:7px 11px;border:1px solid color-mix(in srgb,var(--pink) 35%,transparent);border-radius:999px;background:color-mix(in srgb,var(--pink) 8%,transparent);color:var(--pink);font-size:12px;box-shadow:0 5px 18px color-mix(in srgb,var(--crust) 28%,transparent)}.agent-activity::before{content:'';width:7px;height:7px;border-radius:50%;background:currentColor;box-shadow:0 0 0 4px color-mix(in srgb,var(--pink) 10%,transparent);animation:pulse 1.2s ease-in-out infinite}@keyframes pulse{50%{opacity:.35;transform:scale(.75)}}
.composer{border-top:1px solid var(--line);padding:12px 15px 14px;background:color-mix(in srgb,var(--mantle) 93%,transparent);backdrop-filter:blur(18px)}.input-shell{border:1px solid var(--surface1);border-radius:22px;background:var(--base);box-shadow:inset 0 1px 2px color-mix(in srgb,var(--crust) 50%,transparent),0 8px 30px color-mix(in srgb,var(--crust) 22%,transparent);overflow:hidden;transition:.15s border-color,.15s box-shadow}.input-shell:focus-within{border-color:var(--lavender);box-shadow:0 0 0 3px color-mix(in srgb,var(--lavender) 12%,transparent),0 8px 30px color-mix(in srgb,var(--crust) 28%,transparent)}.row{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.grow{flex:1}textarea,select,button,input{font:inherit}textarea{display:block;width:100%;min-height:66px;max-height:220px;resize:none;border:0;padding:14px 15px 6px;background:transparent;color:var(--text);outline:none}textarea::placeholder{color:var(--overlay)}button,.button{border:1px solid var(--surface1);border-radius:14px;padding:9px 12px;background:var(--surface0);color:var(--text);cursor:pointer;transition:.15s transform,.15s background,.15s border-color}button:hover,.button:hover{background:var(--surface1);border-color:var(--overlay);transform:translateY(-1px)}button:disabled{opacity:.55;cursor:wait}.icon-button{width:38px;height:38px;display:inline-grid;place-items:center;flex:0 0 38px;padding:0;border-radius:13px}.icon-button svg{width:19px;height:19px;fill:none;stroke:currentColor;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}.primary{background:var(--mauve);border-color:var(--mauve);color:var(--crust);font-weight:700;box-shadow:0 6px 18px color-mix(in srgb,var(--mauve) 18%,transparent)}.primary:hover{background:var(--lavender);border-color:var(--lavender)}.quiet{padding:7px 10px;font-size:12px}.recording{background:color-mix(in srgb,var(--red) 14%,transparent);border-color:var(--red);color:var(--red)}.composer-tools{padding:6px 7px 7px}.shortcut-help{color:var(--overlay);font-size:10px;white-space:nowrap}.attachments{display:flex;gap:6px;flex-wrap:wrap;margin:0;padding:0 10px 7px}.attachments:empty{display:none}.chip{background:color-mix(in srgb,var(--blue) 8%,transparent);border:1px solid color-mix(in srgb,var(--blue) 27%,transparent);color:var(--blue);border-radius:999px;padding:5px 9px;font-size:12px}.status{display:flex;width:fit-content;max-width:100%;align-items:center;gap:7px;margin-top:9px;padding:6px 10px;border:1px solid color-mix(in srgb,var(--teal) 20%,transparent);border-radius:999px;background:color-mix(in srgb,var(--teal) 6%,transparent);color:var(--teal);font-size:12px;line-height:1.3}.status::before{content:'';width:7px;height:7px;flex:0 0 7px;border-radius:50%;background:currentColor;box-shadow:0 0 0 3px color-mix(in srgb,var(--teal) 9%,transparent)}fieldset{margin:12px 0 0;padding:12px;border:1px solid var(--surface0);border-radius:14px;display:grid;grid-template-columns:1fr;gap:9px}label{display:flex;gap:7px;align-items:center}select{min-width:0;flex:1;background:var(--base);color:var(--text);border:1px solid var(--surface1);border-radius:10px;padding:7px}input[type=checkbox]{accent-color:var(--mauve)}audio{width:100%;margin-top:10px}.hidden{display:none}
.sidebar{position:absolute;z-index:30;inset:0 auto 0 0;width:min(310px,88%);padding:16px;display:flex;flex-direction:column;background:color-mix(in srgb,var(--mantle) 98%,transparent);border-right:1px solid var(--surface0);box-shadow:18px 0 60px color-mix(in srgb,var(--crust) 67%,transparent);transform:translateX(-105%);transition:transform .2s ease}.sidebar.open{transform:translateX(0)}.scrim{position:absolute;z-index:25;inset:0;background:color-mix(in srgb,var(--crust) 60%,transparent);backdrop-filter:blur(2px);opacity:0;pointer-events:none;transition:opacity .2s}.scrim.open{opacity:1;pointer-events:auto}.sidebar-head{display:flex;align-items:center;gap:10px;margin-bottom:16px}.sidebar-head strong{font-size:17px}.new-chat{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;border-color:color-mix(in srgb,var(--mauve) 30%,transparent);background:color-mix(in srgb,var(--mauve) 8%,transparent);color:var(--mauve)}.new-chat svg{width:17px;height:17px;fill:none;stroke:currentColor;stroke-width:2}.history-label{margin:18px 4px 8px;color:var(--overlay);font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.session-list{display:flex;flex:1;min-height:0;overflow:auto;flex-direction:column;gap:5px}.session-item{display:block;width:100%;padding:10px 11px;text-align:left;border-color:transparent;background:transparent}.session-item:hover{background:var(--surface0)}.session-item.active{border-color:color-mix(in srgb,var(--lavender) 26%,transparent);background:color-mix(in srgb,var(--lavender) 6%,transparent)}.session-title{display:block;color:var(--text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.session-time{display:block;margin-top:3px;color:var(--overlay);font-size:10px}.sidebar-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px;padding-top:12px;border-top:1px solid var(--surface0)}
.settings-panel{position:absolute;z-index:20;top:68px;right:14px;width:min(440px,calc(100% - 28px));max-height:calc(100% - 84px);overflow:auto;padding:15px;border:1px solid var(--surface1);border-radius:18px;background:color-mix(in srgb,var(--mantle) 97%,transparent);box-shadow:0 18px 60px color-mix(in srgb,var(--crust) 78%,transparent);transform:translateY(-8px) scale(.98);opacity:0;pointer-events:none;transition:.15s}.settings-panel.open{transform:none;opacity:1;pointer-events:auto}.settings-title{display:flex;align-items:center;justify-content:space-between}.settings-title strong{font-size:16px}.setting-row{justify-content:space-between;margin-top:13px;padding:10px 11px;border-radius:13px;background:var(--base);border:1px solid var(--surface0)}.setting-row small{color:var(--overlay)}.settings-panel #limits{display:block;max-width:none;margin-top:10px;white-space:normal}.top .icon-button{border-color:transparent;background:transparent}.top .icon-button:hover{border-color:var(--surface1);background:var(--surface0)}
.media-strip{display:flex;gap:7px;max-width:100%;margin-top:10px;padding-bottom:2px;overflow-x:auto;scrollbar-width:thin}.media-tile{width:64px;min-width:64px;padding:5px;border:1px solid var(--surface1);border-radius:13px;background:color-mix(in srgb,var(--surface0) 66%,transparent);color:var(--subtext);text-decoration:none;cursor:pointer;transition:.15s transform,.15s border-color}.media-tile:hover{border-color:var(--lavender);transform:translateY(-1px)}.media-thumb{width:52px;height:42px;display:grid;place-items:center;border-radius:9px;background:var(--base);overflow:hidden}.media-thumb img{width:100%;height:100%;object-fit:cover}.media-thumb svg{width:22px;height:22px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.media-tile.image{color:var(--green)}.media-tile.video{color:var(--mauve)}.media-tile.audio{color:var(--peach)}.media-tile.document{color:var(--blue)}.media-name{display:block;margin-top:4px;overflow:hidden;color:var(--subtext);font-size:9px;text-overflow:ellipsis;white-space:nowrap}.attachments .media-strip{margin:0}.attachments .media-tile{width:58px;min-width:58px}.attachments .media-thumb{width:46px;height:36px}.voice-config,.api-key-config,.appearance-config,.prompt-config{margin-top:12px;padding:11px;border:1px solid var(--surface0);border-radius:14px;background:var(--base)}.voice-config>label,.appearance-config>label{justify-content:space-between}.voice-controls{margin-top:10px;padding-top:10px;border-top:1px solid var(--surface0)}.voice-actions,.logo-actions,.prompt-actions{display:flex;align-items:center;gap:6px;flex-wrap:wrap}.voice-actions button,.voice-actions .button,.logo-actions button,.logo-actions .button,.prompt-actions button{padding:7px 9px;font-size:11px}.voice-file,.logo-file{margin:8px 0 0;color:var(--peach);font-size:11px}.voice-config audio{height:34px;margin:8px 0}.voice-config .transcript{display:block;margin-top:8px;color:var(--subtext);font-size:11px}.voice-config input[type=text],.api-key-config input,.prompt-config textarea{display:block;width:100%;margin-top:5px;padding:8px 9px;border:1px solid var(--surface1);border-radius:10px;background:var(--mantle);color:var(--text);outline:none}.prompt-config label{display:block;margin-top:9px;color:var(--subtext);font-size:11px}.prompt-config textarea{min-height:86px;max-height:190px;resize:vertical}.voice-config input[type=text]:focus,.api-key-config input:focus,.prompt-config textarea:focus{border-color:var(--lavender)}.voice-note,.setting-note{display:block;margin-top:7px;color:var(--overlay);font-size:10px;line-height:1.4}.api-key-config label{display:block;color:var(--subtext);font-size:11px}.api-key-actions{display:flex;align-items:center;gap:8px;margin-top:8px}.api-key-actions small{color:var(--overlay)}
...
<aside class="sidebar" id="sidebar" aria-label="Chat history">
  <div class="sidebar-head"><img class="logo" data-mica-logo src="/mica-logo.svg" alt=""><strong>Conversations</strong><span class="grow"></span><button class="icon-button" id="closeMenu" aria-label="Close chat history" title="Close chat history"><svg viewBox="0 0 24 24"><path d="m7 7 10 10M17 7 7 17"/></svg></button></div>
...
<div class="top">
  ...
  <div class="brand"><img class="logo" data-mica-logo src="/mica-logo.svg" alt=""><div class="title"><strong>Local Assistant</strong></div></div>
...
<section class="settings-panel" id="settingsPanel" aria-label="Chat settings">
  ...
  <div class="appearance-config">
    <label><span><strong>Theme</strong><br><small>Saved in this browser</small></span><select id="theme"><option value="mocha">Catppuccin Mocha</option><option value="macchiato">Catppuccin Macchiato</option><option value="frappe">Catppuccin Frappé</option><option value="latte">Catppuccin Latte</option></select></label>
    <div class="logo-actions"><label class="button">Choose logo<input class="hidden" id="logoUpload" type="file" accept="image/png,image/jpeg,image/webp"></label><button id="logoReset" type="button">Use Mica logo</button></div>
    <div class="logo-file" id="logoName">Mica logo</div><small class="setting-note">A PNG, JPEG, or WebP up to 2 MiB replaces the assistant avatar and header logo locally.</small>
  </div>
  ...
  <div class="prompt-config">
    ...
    <small class="setting-note">These prompts can define any persona or behavior. Mica still enforces attachment allowlists and tool-routing safety.</small>
    <label>Assistant / LLM system prompt<textarea id="llmSystemPrompt" maxlength="16384" placeholder="Optional instructions for the main assistant"></textarea></label>
    <label>Media / VLM system prompt<textarea id="vlmSystemPrompt" maxlength="16384" placeholder="Optional instructions for image, video, and document analysis"></textarea></label>
    <div class="prompt-actions"><button id="resetPrompts" type="button">Clear prompts</button><small class="setting-note">Saved only in this browser and sent with each chat request.</small></div>
  </div>
...
let customLogoBlob=null,customLogoFilename='';
...
function settingsDatabase(){return new Promise((resolve,reject)=>{let request=indexedDB.open('mica-playground',1);request.onupgradeneeded=()=>{if(!request.result.objectStoreNames.contains('settings'))request.result.createObjectStore('settings')};request.onsuccess=()=>resolve(request.result);request.onerror=()=>reject(request.error)})}
async function settingValue(mode,key,value){let db=await settingsDatabase();return new Promise((resolve,reject)=>{let transaction=db.transaction('settings',mode),store=transaction.objectStore('settings'),request=value===undefined?store.get(key):value===null?store.delete(key):store.put(value,key);request.onsuccess=()=>resolve(request.result);request.onerror=()=>reject(request.error);transaction.oncomplete=()=>db.close()})}
function applyTheme(value){let allowed=['mocha','macchiato','frappe','latte'],theme=allowed.includes(value)?value:'mocha';document.documentElement.dataset.theme=theme;$('theme').value=theme;localStorage.micaTheme=theme}
function logoSource(){return customLogoBlob?objectUrl(customLogoBlob):'/mica-logo.svg'}
function applyLogo(){let source=logoSource();document.querySelectorAll('[data-mica-logo]').forEach(image=>image.src=source);$('logoName').textContent=customLogoBlob?`${customLogoFilename||'Custom logo'} · ${(customLogoBlob.size/1024).toFixed(0)} KiB`:'Mica logo'}
async function loadLogo(){let saved=await settingValue('readonly','custom-logo');if(saved?.blob){customLogoBlob=saved.blob;customLogoFilename=saved.name||'Custom logo'}applyLogo()}
function loadPrompts(){$('llmSystemPrompt').value=localStorage.getItem('micaLlmSystemPrompt')||'';$('vlmSystemPrompt').value=localStorage.getItem('micaVlmSystemPrompt')||''}
async function persistTtsVoice(){if(!ttsVoiceBlob)return;await settingValue('readwrite','tts-reference',{blob:ttsVoiceBlob,name:ttsVoiceFilename||'Reference voice.wav',text:$('ttsVoiceText').value.trim()})}
...
async function loadTtsVoice(){let saved=await settingValue('readonly','tts-reference');if(saved?.blob){ttsVoiceBlob=saved.blob;ttsVoiceFilename=saved.name||'Reference voice.wav';$('ttsVoiceText').value=saved.text||''}$('ttsVoiceMode').value=localStorage.micaTtsVoiceMode==='reference'?'reference':'default';updateTtsVoiceUi()}
...
async function init(){verifyMarkdownRenderer();applyTheme(localStorage.micaTheme||'mocha');loadPrompts();try{await loadLogo()}catch{applyLogo()}updateApiKeyUi();let r=await requireOk(await apiFetch('/api/models')),j=await r.json();rows=j.data||[];capability('llm','text','q4');capability('vlm','vision','q4');capability('asr','asr','q4');capability('tts','tts','q8');
...
$('logoUpload').onchange=async event=>{let file=event.target.files[0];if(!file)return;try{if(!['image/png','image/jpeg','image/webp'].includes(file.type))throw Error('Custom logos must be PNG, JPEG, or WebP.');if(file.size>2*1024*1024)throw Error('Custom logos must be 2 MiB or smaller.');customLogoBlob=file;customLogoFilename=file.name;await settingValue('readwrite','custom-logo',{blob:file,name:file.name});applyLogo();status('Custom chat logo saved in this browser.')}catch(error){status('ERROR: '+error.message)}finally{event.target.value=''}};
$('logoReset').onclick=async()=>{customLogoBlob=null;customLogoFilename='';await settingValue('readwrite','custom-logo',null);applyLogo();status('Restored the Mica logo.')};
$('llmSystemPrompt').oninput=event=>localStorage.setItem('micaLlmSystemPrompt',event.target.value);
$('vlmSystemPrompt').oninput=event=>localStorage.setItem('micaVlmSystemPrompt',event.target.value);
$('resetPrompts').onclick=()=>{$('llmSystemPrompt').value='';$('vlmSystemPrompt').value='';localStorage.removeItem('micaLlmSystemPrompt');localStorage.removeItem('micaVlmSystemPrompt');status('Custom system prompts cleared.')};
