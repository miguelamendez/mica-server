...
mica.model {
  id = "spark-x25-4b",
  capability = "text",
  description = "Spark-X2.5-4B text model; its 1.7B sibling is only an experimental classic draft candidate, not native MTP.",
  tags = {"text-generation", "speculative-draft-candidate", "commercial-use", "apache-2.0"},
